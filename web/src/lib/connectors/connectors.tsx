    ...
    advanced_values: [
      {
        ...
        name: "include_prs",
        optional: true,
        description: "Index open, merged, and declined pull requests",
        default: true,
      },
      {
        type: "checkbox",
        query: "Include repository details?",
        label: "Include Repository Details",
        name: "include_repo",
        optional: true,
        description: "Index name, description, language, and default branch",
        default: true,
      },
      {
        type: "checkbox",
        query: "Include README?",
        label: "Include README",
        name: "include_readme",
        optional: true,
        description: "Index the README on the default branch",
        default: true,
      },
      {
        type: "checkbox",
        ...
        name: "include_commits",
        optional: true,
        description: "Index commit messages on the default branch (not diffs)",
        default: true,
      },
    ],
  },
